...
\emph{Schule (nah) -> Moebeliert (nein) -> Zimmerzahl (4) -> Kindergarten (nah) -> Kehrwoche (ja)}.
...
Betrachtet man zusätzlich die eigentlichen Trainingsdaten so finden sich lediglich zwei Datensätze.
...
\todoask[inline]{Ich bin mir mit der Reihenfolge nicht ganz sicher...\\
Erst Genau den Baum Beschreiben, oder erst den Unterschied zwische T0 \& T1}
