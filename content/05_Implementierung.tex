...
Um die Übersichtlichkeit nicht weiter Einzuschränkten wird auf das Auflisten der Funktionsparameter verzichtet.
In \autoref{appendix:klassendiagramm} ist das gesamte Diagramm nochmals vergrößert abgebilsted.
